...
function onUse(cid, item, frompos, item2, topos)
  ...
  local Data = LOCATION_ROOKGARD.ItemAction
  
  if Data[item.uid] ~= nil then
  ...
  if item.uid == 7038 then
    ...
    SPIKESWORDKEY = doPlayerAddItem(cid, LOCATION_ROOKGARD.Items.goldenkey, 1)
  ...
  elseif item.uid == 7039 then
    ...
    KEY = doPlayerAddItem(cid, LOCATION_ROOKGARD.Items.copperkey, 1)
