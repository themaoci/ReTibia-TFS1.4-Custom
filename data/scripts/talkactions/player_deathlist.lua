...
local player_deathlist = TalkAction("!deathlist", "!rip", "!deaths")

function player_deathlist.onSay(player, words, param)
...
player_deathlist:separator(" ")
player_deathlist:register()