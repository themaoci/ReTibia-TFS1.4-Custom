...
local function findPushPosition(creature, round)
	...
	for _, offset in ipairs(positionOffsets) do
		local offsetPosition = pos
    offsetPosition.x = offsetPosition.x + offset.x
    offsetPosition.y = offsetPosition.y + offset.y
    offsetPosition.z = offsetPosition.z + offset.z
