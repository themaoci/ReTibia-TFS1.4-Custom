...
bool ConfigManager::load()
{
	...
	integer[SECURITY_FILESIZE] = getGlobalNumber(L, "sec_fileSize");
	integer[SECURITY_DATSIG] = getGlobalNumber(L, "sec_datSig");
	integer[SECURITY_SPRSIG] = getGlobalNumber(L, "sec_sprSig");
	integer[SECURITY_PICSIG] = getGlobalNumber(L, "sec_picSig");
	integer[SECURITY_MODULESIG] = getGlobalNumber(L, "sec_modulesSig");
