...
addoninfo = {
    ...
    ["first hunter addon"] = {
        cost = 0,
        items = {{5876, 50}, {5948, 50}, {5891, 5}, {5887, 1}, {5889, 1}, {5888, 1}},
        outfit_female = 137,
        outfit_male = 129,
        addon = 1,
        storageID = 10044
    ...
    ["second knight addon"] = {
        cost = 0,
        items = {{5893, 50}, {11422, 1}, {5885, 1}, {5887, 1}},
        outfit_female = 139,
        outfit_male = 131,
        addon = 2,
        storageID = 10047
    ...
    ["first barbarian addon"] = {
        cost = 0,
        items = {{5884, 1}, {5885, 1}, {5910, 25}, {5911, 25}, {5886, 10}},
        outfit_female = 147,
        outfit_male = 143,
        addon = 1,
        storageID = 10011
    ...
    ["second barbarian addon"] = {
        cost = 0,
        items = {{5880, 25}, {5892, 1}, {5893, 25}, {5876, 25}},
        outfit_female = 147,
        outfit_male = 143,
        addon = 2,
        storageID = 10012
    ...
    ["second oriental addon"] = {
        cost = 0,
        items = {{5883, 30}, {5895, 30}, {5891, 2}, {5912, 30}},
        outfit_female = 150,
        outfit_male = 146,
        addon = 2,
        storageID = 10018
    ...
    ["first warrior addon"] = {
        cost = 0,
        items = {{5925, 40}, {5899, 40}, {5884, 1}, {5919, 1}},
        outfit_female = 142,
        outfit_male = 134,
        addon = 1,
        storageID = 10019
    ...
    ["first wizard addon"] = {
        cost = 0,
        items = {{2536, 1}, {2492, 1}, {2488, 1}, {2123, 1}},
        outfit_female = 149,
        outfit_male = 145,
        addon = 1,
        storageID = 10021
    ...
    ["first assassin addon"] = {
        cost = 0,
        items = {{5912, 20}, {5910, 20}, {5911, 20}, {5913, 20}, {5914, 20}, {5909, 20}, {5886, 10}},
        outfit_female = 156,
        outfit_male = 152,
        addon = 1,
        storageID = 10023
    ...
    ["first beggar addon"] = {
        cost = 0,
        items = {{5878, 30}, {5921, 20}, {5913, 10}, {5894, 10}},
        outfit_female = 157,
        outfit_male = 153,
        addon = 1,
        storageID = 10025
...
local talkUser = cid
    ...
    elseif msgcontains(msg, "addon") then
        ...
        player:registerEvent("NPCOutfits_Modal_Window")
