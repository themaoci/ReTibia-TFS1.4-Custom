...
- Commands -]]
  ...
  ["BuySpellsList"] = {
    ...
    {group="conjure", price=0, spellid="176", name="Arrow Call", words="exevo infir con", level="1", premium="0", needlearn="1" },
    {group="runeMaking", price=1200, name="Animate Dead Rune", words="adana mort", level="27", premium="1", needlearn="1" },
    {group="runeMaking", price=1200, name="Avalanche Rune", words="adori mas frigo", level="30", needlearn="1" },
    {group="runeMaking", price=0, name="Blank Rune", words="adori blank", level="5", magiclevel="1", needlearn="1" },
    {group="runeMaking", price=1300, name="Chameleon Rune", words="adevo ina", level="27", needlearn="1" },
    {group="conjure", price=450, spellid="51", name="Conjure Arrow", words="exevo con", level="13", premium="0", needlearn="1" },
    {group="conjure", price=450, spellid="79", name="Conjure Bolt", words="exevo con mort", level="17", premium="1", needlearn="1" },
    {group="conjure", price=1000, spellid="49", name="Conjure Explosive Arrow", words="exevo con flam", level="25", premium="0", needlearn="1" },
    {group="conjure", price=1000, spellid="109", name="Conjure Piercing Bolt", words="exevo con grav", level="33", premium="1", needlearn="1" },
    {group="conjure", price=1000, spellid="48", name="Conjure Poisoned Arrow", words="exevo con pox", level="16", premium="0", needlearn="1" },
    {group="conjure", price=1000, spellid="95", name="Conjure Power Bolt", words="exevo con vis", level="59", premium="1", needlearn="1" },
    {group="conjure", price=1000, spellid="108", name="Conjure Sniper Arrow", words="exevo con hur", level="24", premium="1", needlearn="1" },
    {group="runeMaking", price=800, name="Convince Creature Rune", words="adeta sio", level="16", needlearn="1" },
    {group="runeMaking", price=600, name="Cure Poison Rune", words="adana pox", level="15", needlearn="1" },
    {group="runeMaking", price=700, name="Destroy Field Rune", words="adito grav", level="17", needlearn="1" },
    {group="runeMaking", price=900, name="Disintegrate Rune", words="adito tera", level="21", premium="1", needlearn="1" },
    {group="enchant", price=2000, spellid="110", name="Enchant Spear", words="exeta con", level="45", premium="1", needlearn="1" },
    {group="enchant", price=2000, spellid="92", name="Enchant Staff", words="exeta vis", level="41", premium="1", needlearn="1" },
    {group="runeMaking", price=2300, name="Energy Bomb Rune", words="adevo mas vis", level="37", premium="1", needlearn="1" },
    {group="runeMaking", price=700, name="Energy Field Rune", words="adevo grav vis", level="18", needlearn="1" },
    {group="runeMaking", price=2500, name="Energy Wall Rune", words="adevo mas grav vis", level="41", needlearn="1" },
    {group="runeMaking", price=1800, name="Explosion Rune", words="adevo mas hur", level="31", needlearn="1" },
    {group="runeMaking", price=1500, name="Fire Bomb Rune", words="adevo mas flam", level="27", needlearn="1" },
    {group="runeMaking", price=500, name="Fire Field Rune", words="adevo grav flam", level="15", needlearn="1" },
    {group="runeMaking", price=2000, name="Fire Wall Rune", words="adevo mas grav flam", level="33", needlearn="1" },
    {group="runeMaking", price=1600, name="Fireball Rune", words="adori flam", level="27", premium="1", needlearn="1" },
    {group="runeMaking", price=1200, name="Great Fireball Rune", words="adori mas flam", level="30", needlearn="1" },
    {group="runeMaking", price=1500, name="Heavy Magic Missile Rune", words="adori vis", level="25", needlearn="1" },
    {group="runeMaking", price=1600, name="Holy Missile Rune", words="adori san", level="27", premium="1", needlearn="1" },
    {group="runeMaking", price=1700, name="Icicle Rune", words="adori frigo", level="28", premium="1", needlearn="1" },
    {group="runeMaking", price=600, name="Intense Healing Rune", words="adura gran", level="15", needlearn="1" },
    {group="runeMaking", price=500, name="Light Magic Missile Rune", words="adori min vis", level="15", needlearn="1" },
    {group="runeMaking", price=500, name="Light Stone Shower Rune", words="adori infir mas tera", level="1", premium="1", needlearn="1" },
    {group="runeMaking", price=450, name="Lightest Missile Rune", words="adori infir vis", level="1", needlearn="1" },
    {group="runeMaking", price=2100, name="Magic Wall Rune", words="adevo grav tera", level="32", premium="1", needlearn="1" },
    {group="runeMaking", price=1900, name="Paralyze Rune", words="adana ani", level="54", premium="1", needlearn="1" },
    {group="runeMaking", price=1000, name="Poison Bomb Rune", words="adevo mas pox", level="25", premium="1", needlearn="1" },
    {group="runeMaking", price=300, name="Poison Field Rune", words="adevo grav pox", level="14", needlearn="1" },
    {group="runeMaking", price=1600, name="Poison Wall Rune", words="adevo mas grav pox", level="29", needlearn="1" },
    {group="runeMaking", price=0, name="Practice Magic Missile Rune", words="adori dis min vis", level="1", needlearn="0" },
    {group="runeMaking", price=1800, name="Soulfire Rune", words="adevo res flam", level="27", premium="1", needlearn="1" },
    {group="runeMaking", price=1400, name="Stalagmite Rune", words="adori tera", level="24", premium="0", needlearn="1" },
    {group="runeMaking", price=1100, name="Stone Shower Rune", words="adori mas tera", level="28", premium="1", needlearn="1" },
    {group="runeMaking", price=3000, name="Sudden Death Rune", words="adori gran mort", level="45", needlearn="1" },
    {group="runeMaking", price=1100, name="Thunderstorm Rune", words="adori mas vis", level="28", premium="1", needlearn="1" },
    {group="runeMaking", price=1500, name="Ultimate Healing Rune", words="adura vita", level="24", needlearn="1" },
    {group="runeMaking", price=2000, name="Wild Growth Rune", words="adevo grav vita", level="27", premium="1", needlearn="1" }
  }
}