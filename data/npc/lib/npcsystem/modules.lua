...
if Modules == nil then
	...
	function ShopModule.requestTrade(cid, message, keywords, parameters, node)
		...
		openShopWindow(cid, itemWindow,
			function(cid, itemid, subType, amount, ignoreCap, inBackpacks, specialId) module.npcHandler:onBuy(cid, itemid, subType, amount, ignoreCap, inBackpacks, specialId) end,
			function(cid, itemid, subType, amount, ignoreCap, inBackpacks, specialId) module.npcHandler:onSell(cid, itemid, subType, amount, ignoreCap, inBackpacks, specialId) end)
		module.npcHandler:say(msg, cid)
		return true
	end
