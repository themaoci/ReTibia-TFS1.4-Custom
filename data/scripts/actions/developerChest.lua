...
local ItemsToGive = {
  ...
  [7438] = { amount = 1, cap = 39, name = "elvish bow" }, -- elvish bow
...
local ItemsToGivePotions = {
  [7618] = { amount = 100, cap = 2.7, name = "health potion" }, -- health potion
  [7620] = { amount = 100, cap = 2.7, name = "mana potion" } -- mana potion
}
local ItemsToGiveAmmo = {
  [2544] = { amount = 100, cap = 0.7, name = "arrow bow" }, -- arrow bow
  [2543] = { amount = 100, cap = 0.8, name = "arrow crossbow" }, -- arrow crossbow
  [1294] = { amount = 100, cap = 3.6, name = "small stone" }, -- small stone
  [2389] = { amount = 10, cap = 20, name = "spear" } -- spear
}
local ItemsToGiveCashOnly = {
  [2160] = { amount = 10, cap = 0.1, name = "crystal coin" }, -- crystal coin
  [2169] = { amount = 10, cap = 0.9, name = "time ring" }, -- time ring
  [2214] = { amount = 10, cap = 0.8, name = "ring of healing" } -- ring of healing
}
