...
struct ShopInfo {
	...
	ShopInfo() = default;
	ShopInfo(uint16_t itemId, int32_t subType = 0, uint32_t buyPrice = 0, uint32_t sellPrice = 0, std::string realName = "", uint32_t funcShop = false, uint16_t specialId = 0)
